...
export default function Contactanos() {
  return (
    <div className="w-full flex flex-col justify-center items-center  pt-24 bg-purpleSecondarybm bg-[url('/img/fondoContactanos.png')] bg-cover bg-center bg-no-repeat pb-20">
      <div
        id="contactanos"
