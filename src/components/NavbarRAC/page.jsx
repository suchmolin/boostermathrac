...
export default function NavbarRAC() {
  return (
    <>
      <nav className="hidden absolute w-full h-[100px] xxxl:h-[150px] sm:flex justify-end z-50">
        <div className="absolute top-0 left-10 lg:left-40 xxxl:left-60">
          <div className="relative w-[200px] lg:w-[300px] xxxl:w-[400px] aspect-video">
            <Image
              src="/img/logo.png"
              layout="fill"
              objectFit="contain"
        ...
        <ul className="flex gap-5 lg:gap-12 xxxl:gap-20 justify-center items-center text-base lg:text-xl xxxl:text-4xl font-bold text-bluebm pr-10 xl:pr-64">
