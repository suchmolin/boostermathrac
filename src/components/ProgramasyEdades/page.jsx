  ...
  const data = [
    {
      ...
      title: "Alpha",
      ages: "3-5 AÑOS",
      p1: "Bríndale a tu hijo confianza en sus habilidades numéricas y una base sólida para su futuro.",
      p2: "Exploramos conceptos matemáticos de manera natural, a través del juego",
    ...
    },
    {
      ...
      title: "Beta",
      ages: "6-8 AÑOS",
      p1: "Lo preparamos para enfrentar con confianza los desafíos matemáticos en su desarrollo académico.",
