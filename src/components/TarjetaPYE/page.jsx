  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center md:items-start md:pl-10 xl:pr-32">
        <div className="flex gap-2 3xl:gap-4 items-center mb-2 lg:mb-7">
          ...
          <p className="text-4xl lg:text-5xl 3xl:text-7xl text-bluebm flex flex-col font-[InterBlack] mt-3 md:mt-0">
            {title}{" "}
            <span className="text-xl lg:text-2xl 3xl:text-5xl text-purplebm">
              {ages}
            </span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-bluebm text-2xl sm:text-lg lg:text-xl 3xl:text-4xl font-[InterBlack] ">
              Horario
            </p>
            {horarios.map((item, index) => {
              return (
                <p
                  key={index}
                  className="text-bluebm text-base lg:text-lg 3xl:text-4xl font-bold"
                >
                  {item}
                </p>
              )
        ...
        <a
          href="#contactanos"
          className="text-white py-2 3xl:py-3 px-9 3xl:px-12 rounded-md bg-purplebm w-fit font-bold text-lg lg:text-xl 3xl:text-3xl tracking-wider my-5 hover:shadow-2xl hover:bg-opacity-80 transition-all duration-300"
        >
          Más información
        </a>
      </div>
