...
export default function VidSectionRAC() {
  return (
    <div className="w-full flex flex-col items-center justify-center sm:pt-24 pb-10 sm:pb-0 ">
      <div className="w-[250px] xs:w-[350px] sm:w-[600px] md:w-[740px] 3xl:w-[1000px] border-LightBlueSecondarybm border-[5px] sm:border-[15px] rounded-[40px] bg-white flex items-center justify-center overflow-hidden">
      ...
      <h2 className="text-xl xs:text-lg sm:text-2xl 3xl:text-4xl text-lightBluebm leading-[25px] pt-3 text-center px-4 xs:px-0">
        Este Año Escolar, las matemáticas dejarán <br /> de ser un problema con
        nuestro
      </h2>
      <h3 className="text-2xl sm:text-3xl 3xl:text-5xl text-purplebm font-bold text-center">
